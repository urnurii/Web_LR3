<footer>
    <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '\2192';">
                <ul class="breadcrumb justify-content-start mb-0">
                    ...
                    <li class="breadcrumb-item small"><a href="#" class="">Образовательные
                            программы
                            бакалавриата</a></li>
                    <li class="breadcrumb-item small"><a href="#" class="">Факультет компьютерных
                            наук</a></li>
                    <li class="breadcrumb-item small active text-black"><a href="#" class="">Образовательная
        ...
        <div class="row mx-5 mb-1">
            <div class="col">
                <a href="#" class="text-black red-link d-block mb-2 fw-bold">О ВЫШКЕ</a>
                ...
                <a href="#" class="red-link d-block mb-2">Сведения о доходах, расходах, об имуществе и
                    обязательствах
        ...
        <div class="row mx-5 mt-4">
            <p class="text-secondary small">© НИУ ВШЭ 1993–2025
                <a href="#" class="red-link">Адреса и контакты</a>
                <a href="#" class="red-link">Условия использования материалов</a>
                <a href="#" class="red-link">Политика конфиденциальности</a>
                <a href="#" class="red-link">Карта сайта</a>
                <br>Шрифты HSE Sans и HSE Slab разработаны в Школе дизайна НИУ ВШЭ
            </p>
        </div>
    </div>
</footer>
<script src="/LR2_Wedding/js/bootstrap.bundle.js"></script>
